...
\newenvironment{proof-sketch}{\noindent{\bf Esboço da demonstração:}\hspace*{1em}}{\qed\bigskip\\}
\newenvironment{proof-idea}{\noindent{\bf Ideia da demonstração:}\hspace*{1em}}{\qed\bigskip\\}
\newenvironment{proof-of-lemma}[1]{\noindent{\bf Demonstração do Lema #1:}\hspace*{1em}}{\qed\bigskip\\}
\newenvironment{proof-of-claim}[1]{\noindent{\bf Demonstração da Afirmativa #1:}\hspace*{1em}}{\qed\bigskip\\}
\newenvironment{proof-attempt}{\noindent{\bf Tentativa de demonstração:}\hspace*{1em}}{\qed\bigskip\\}
...
%================================
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=section]{corolary}{Corolário}
{%
	enhanced
	,breakable
	,colback = myp!10
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=section]{claim}{Afirmativa}
{%
	enhanced
	,breakable
	,colback = myg!10
...
\newtcbtheorem[number within=section]{open}{Questão}{enhanced,
...
\makeatletter
\newtcbtheorem[number within=chapter]{problem}{Problema}{enhanced,
	breakable,
	colback=white,
...
\makeatletter
\newtcbtheorem[number within=chapter]{prob}{Problema}{enhanced,
	breakable,
	colback=white,
	colframe=mygr,
	attach boxed title to top left={yshift*=-\tcboxedtitleheight},
...
\newtcbtheorem[number within=chapter]{wconc}{Conceito errado}{
	breakable,
	enhanced,
	colback=white,
	colframe=myr,
...
%		\foreach \i in {2.5,...,32}
%		{
%			\node[rounded corners,blue!80,draw,regular polygon,regular polygon sides=6, minimum size=\i cm,ultra thick] at ($(current page.west)+(2.5,-5)$) {} ;
%		}
		
%		\foreach \i in {0.5,...,22}
%		{
%			\node[rounded corners,blue!80,draw,regular polygon,regular polygon sides=6, minimum size=\i cm,ultra thick] at ($(current page.north west)+(2.5,0)$) {} ;
%		}
		
%		\foreach \i in {0.5,...,62}
%		{
%			\node[rounded corners,gray!50,draw,regular polygon,regular polygon sides=6, minimum size=\i cm,ultra thick] at ($(current page.north east)+(0,-9.5)$) {} ;
%		}
		
		
%		\foreach \i in {21,...,6}
%		{
%			\node[blue!85,rounded corners,draw,regular polygon,regular polygon sides=6, minimum size=\i cm,ultra thick] at ($(current page.south east)+(-0.2,-0.45)$) {} ;
%		}
		
		
		%%%%%%%%%%%%%%%%%%%% Title of the Report %%%%%%%%%%%%%%%%%%%% 
		\node[left,blue!80,minimum width=0.625*\paperwidth,minimum height=3cm, rounded corners] at ($(current page.north east)+(0,-9.5)$)
		{
		...
		%%%%%%%%%%%%%%%%%%%% Author Name %%%%%%%%%%%%%%%%%%%% 
		\node[left,blue!60,minimum width=0.625*\paperwidth,minimum height=2cm, rounded corners] at ($(current page.north east)+(0,-13)$)
		{
			{\Large \textsc{#3}}
		};
		
		%%%%%%%%%%%%%%%%%%%% Year %%%%%%%%%%%%%%%%%%%% 
		\node[left,black,minimum width=0.625*\paperwidth,minimum height=2cm, rounded corners] at ($(current page.north east)+(0,-15)$)
		{
			{\Large \textsc{#4}}
		};


%		\node[rounded corners,fill=black!40,text =white,regular polygon,regular polygon sides=4, minimum size=1.5 cm,inner sep=0,ultra thick] at ($(current page.center)+(0,-10)$) {\large \bfseries #4};
